...
import somelang.AST.Program;
import somelang.parser.SomeLangLexer;
import somelang.parser.SomeLangParser;
...
public class Reader {
	...
	Program parse(String programText) {
		SomeLangLexer l = new SomeLangLexer(new org.antlr.v4.runtime.ANTLRInputStream(programText));
		SomeLangParser p = new SomeLangParser(new org.antlr.v4.runtime.CommonTokenStream(l));
	...
	protected String getProgramDirectory() { return "build"+File.separator+"somelang"+File.separator+"examples"+File.separator; }
